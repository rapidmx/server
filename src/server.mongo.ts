...
///////////////////////////////////////////////////////////////////////////////
// The process a deployment runs. It starts the actual server (worker.mongo.ts) as a child process and starts it
...
const worker = new URL(import.meta.url.endsWith(".ts") ? "./worker.mongo.ts" : "./worker.mongo.js", import.meta.url);
